    ...
    <main>
        ...
        <section class="search-panel">
           ...
           <select class="search-field" name="from" id="" placeholder="Destination">
            ...
            <!-- <button type="button" id="decrement-days" onclick="decrementDays()" class="counter-btn">−</button>             -->
            <input type="number" class="days-field" name="days" id="add-days" min="1" max="30" placeholder="Days">
              <!-- <button type="button" id="increment-days" onclick="incrementDays()" class="counter-btn">+</button> -->
                    ...
                    <div class="form-popup" id="myForm" aria-hidden="true">
                        <div class="form-container small">
                            ...
                            <div class="counter-controls">
                                <button type="button" id="decrement-people" onclick="decrementPoeple()" class="counter-btn">−</button>
                                <span id="total-people">1</span>
                                <button type="button" id="increment-people" onclick="incrementPoeple()" class="counter-btn">+</button>
