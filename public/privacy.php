...
<head>
    ...
    <title>Voyage - Privacy Policy</title>
</head>
<body class="font">
    <header>
        <div class="nav-bar">
    ...
    <main>
        <section class="page-section">
            ...
            <p class="page-subtitle">Your privacy is important to us. Please read our privacy policy carefully.</p>
        </section>

        <section class="text-content">
            <h3>1. Introduction</h3>
            <p>Voyage ("we", "our", or "us") operates the Voyage website. This page informs you of our policies regarding the collection, use, and disclosure of personal data when you use our Service and the choices you have associated with that data.</p>

            <h3>2. Types of Data Collected</h3>
            <p><strong>Personal Data:</strong> While using our Service, we may ask you to provide us with certain personally identifiable information that can be used to contact or identify you ("Personal Data"). This may include, but is not limited to:</p>
            <p>• Email address<br>• First name and last name<br>• Phone number<br>• Address, State, Province, ZIP/Postal code, City<br>• Cookies and Usage Data</p>

            <p><strong>Usage Data:</strong> We may also collect information on how the Service is accessed and used ("Usage Data"). This may include information such as your computer's Internet Protocol address (e.g. IP address), browser type, browser version, the pages you visit, the time and date of your visit, and other diagnostic data.</p>

            <h3>3. Use of Data</h3>
            <p>Voyage uses the collected data for various purposes:</p>
            <p>• To provide and maintain our Service<br>• To notify you about changes to our Service<br>• To allow you to participate in interactive features of our Service<br>• To provide customer support<br>• To gather analysis or valuable information so that we can improve our Service<br>• To monitor the usage of our Service<br>• To detect, prevent and address technical issues</p>
            ...
            <p><strong>Email:</strong> privacy@voyage.nl<br><strong>Phone:</strong> +31 (0) 24 XXX XX XX<br><strong>Address:</strong> Nijmegen, Netherlands</p>
        </section>
    </main>
